...
Matrix.prototype = {
   ...
   rotateX : function(theta) {
      ...
      this._tmp1[1][1] = Math.cos(theta);
      this._tmp1[1][2] = -Math.sin(theta);
      this._tmp1[2][1] = Math.sin(theta);
      this._tmp1[2][2] = Math.cos(theta);
   ...
   rotateY : function(theta) {
      ...
      this._makeIdentity(this._tmp1);
      this._tmp1[0][0] = Math.cos(theta);
      this._tmp1[0][2] = Math.sin(theta);
      this._tmp1[2][0] = -Math.sin(theta);
      this._tmp1[2][2] = Math.cos(theta);
   ...
   rotateZ : function(theta) {
      ...
      this._makeIdentity(this._tmp1);
      this._tmp1[0][0] = Math.cos(theta);
      this._tmp1[0][1] = -Math.sin(theta);
      this._tmp1[1][0] = Math.sin(theta);
      this._tmp1[1][1] = Math.cos(theta);
